#!/usr/bin/env bun
/**
 * fstack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   fstack-global-discover --since 7d [--format json|summary]
 *   fstack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: fstack-global-discover --since <window> [--format json|summary]
...
Examples:
  fstack-global-discover --since 7d
  fstack-global-discover --since 14d --format summary`);
}
