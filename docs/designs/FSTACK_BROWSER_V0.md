...
A double-clickable macOS .app that wraps Playwright's Chromium with the fstack
...
and run any fstack skill. All without touching a terminal.
...
Every fstack skill becomes a browser capability.
...
| `FSTACK_CHROMIUM_PATH` | **SHIPPED** | Custom Chromium binary support |
