...
- Save the report to .fstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.fstack', 'security-reports');
...
- Skip the preamble (fstack-update-check, telemetry, etc.) — go straight to the audit.
