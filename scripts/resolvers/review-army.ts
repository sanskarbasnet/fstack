 ...
 * 1. Detect stack and scope (via fstack-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/fstack-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/fstack-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/fstack-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
