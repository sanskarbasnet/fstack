# Design System — fstack

## Product Context
- **What this is:** Community website for fstack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering fstack, existing community members
