...
-- wishlist: future ideas. Separate from intents — intents are NOW (active
-- on a branch); wishlist items are LATER (no branch, no commitment).
-- Promote a wishlist row to an intent when ready to act.
