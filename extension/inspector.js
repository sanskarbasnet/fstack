/**
 * fstack browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__fstackInspectorActive) return;
  window.__fstackInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'fstack-inspector-highlight';
    ...
    tooltipEl.id = 'fstack-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'fstack-inspector-highlight' || target.id === 'fstack-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `fstack-inject-${id}`;
